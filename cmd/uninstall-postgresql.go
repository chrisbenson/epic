...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		err := epic.UninstallPostgreSQLDatabase(adminUser, adminPassword, server, database)
		resetCreds()
		if err != nil {
			fmt.Println(err)
		} else {
...
func init() {
	...
	uninstallPostgreSQLCmd.Flags().StringVarP(&database, "database", "d", "", "--database database, -d database")
	...
	uninstallPostgreSQLCmd.MarkFlagRequired("database")
